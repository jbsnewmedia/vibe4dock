...
Diese Dokumentation beschreibt **Vibe4Dock 1.0.3**.
...
Die mitgelieferten Definitionen für **Vibe4Dock 1.0.3** werden aus folgenden Pfaden geladen:
...
Die mitgelieferten Tool-Dateien sind in Version 1.0.3 bereits Teil des Repositories, und zusätzliche team- oder projektspezifische Packs können über denselben Merge-Mechanismus darübergelegt werden.
